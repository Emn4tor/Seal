    ...
    <div className="flex h-full items-center justify-center bg-ink px-6">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 space-y-2">
          {accounts.map((account) => (
            <button
              ...
              className="flex w-full items-center justify-between rounded-md border border-border bg-surface px-4 py-3 text-left transition hover:border-brass-dim disabled:cursor-not-allowed disabled:opacity-40"
            >
              <span>
        ...
        <button
          ...
          disabled={busy}
          className="mt-4 w-full rounded-md border border-border px-4 py-2.5 text-[15px] font-medium text-brass transition hover:border-brass-dim hover:bg-brass-wash disabled:cursor-not-allowed disabled:opacity-40"
        >
          Add another account
        </button>
      </div>
